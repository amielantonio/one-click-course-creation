...
<?php
    if(isset($course)){
        ...
        $aac = $course['awc_active_course'] == 1 || $course['awc_active_course'] == 'on'? 'checked' : '';
        $apc = $course['awc_private_comments'] != "" ? 'checked' : '';
        $edcd = $course['email_daily_comment_digest'] == 1 || $course['email_daily_comment_digest'] == 'on'? 'checked' : '';
