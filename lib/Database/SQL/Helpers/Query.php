...
use AWC\Database\SQL\Helpers\Grammar;
use AWC\Database\SQL\Helpers\Expression;
use AWC\Database\SQL\Helpers\JoinClause;
use AWC\Helpers\Arr;
use Closure;
use Exception;
...
class Query {
    ...
    /**
     * @var \AWC\Database\SQL\Helpers\Grammar
     */
    protected $grammar;
