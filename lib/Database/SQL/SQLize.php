...
namespace AWC\Database\SQL;

use Closure;
use AWC\Database\SQL\Blueprint;
use AWC\Database\SQL\Helpers\Column;
...
class SQLize{
     ...
     *
     * @var \AWC\Database\SQL\Blueprint;
     */
    protected $blueprint;
     ...
     * SQLize constructor.
     *
     * @param \AWC\Database\SQL\Blueprint $blueprint
     */
